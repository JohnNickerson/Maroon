...
namespace UnitTests
{
    ...
    public class TokeniseTests
    {
        ...
        public void TestTokenise()
        {
            ...
            Assert.AreEqual(true, Guid.TryParse(tokens[0], out _));
            Assert.AreEqual("Archer (2009)\\Season 8\\Archer (2009).S08E07.Archer Dreamland Gramercy, Halberd!.mkv", tokens[6]);
        }
    }
}
